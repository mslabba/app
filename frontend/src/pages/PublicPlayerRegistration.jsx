    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 py-12 px-4">
      <div className="container mx-auto max-w-2xl">
        ...
        <div className="text-center mb-8">
          ...
          {event && (
            <div>
              <h2 className="text-2xl text-white/80 mb-2">{event.name}</h2>
              <p className="text-white/60">Date: {new Date(event.date).toLocaleDateString()}</p>
            </div>
          )}
        </div>
        ...
        <Card className="glass border-white/20 shadow-2xl">
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              {/* Playing Information */}
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-gray-900">Playing Information</h3>
              ...
              {/* Statistics */}
              <div className="space-y-4">
                <h3 className="text-lg font-semibold text-gray-900">Career Statistics (Optional)</h3>
